        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title text-center">Add New Employee</h1>
                </div>
                <div class="card-body">
                    ...
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="mobilenumber" class="form-control"  placeholder="Enter Your MobileNumber" >
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary"><b>Add New Employee</b></button><br>
...
<?php /**PATH C:\Users\ACER\Desktop\Project Laravel\Employeems\employee-app\resources\views/addemployee.blade.php ENDPATH**/ ?>